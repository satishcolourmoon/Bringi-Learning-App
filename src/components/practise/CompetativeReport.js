...
export default class CompetativeReport extends React.Component {
    ...
    getUserAsesmentList = async (student_id) => {
        let postData = {
            action: 'student_completed_compitative_tests_list',
            student_id
        }
    ...
    getSubjectAnalysis = (subject_id, name) => {
        this.props.navigation.navigate('AdaptiveSubjectReport', {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.backMainContainer}>
                    ...
                    <View style={styles.descContainer}>
                        <Text style={styles.heading}>Competitive</Text>
                        <Text style={styles.heading}>Practice</Text>
                    </View>
                </View>
                {/* <Header title="Competitive" title1="Practice" backScreen="SkillAssessment" headerImage="la" navigation={this.props.navigation} /> */}
                <View style={styles.secondContainer}>
                    <View style={styles.horizontalContainer}>
                        <View style={[styles.row, { marginTop: hp('20') }]}>
                                ...
                                <TouchableWithoutFeedback onPress={() => this.getAnalysisData()}>
                                    <View>
                                        ...
                                        <View style={styles.center}>
                                            <Text style={this.state.selectedId == 0 ? styles.circleText1 : styles.circleText}>Competitive</Text>
                                        </View>
                                    </View>
                                </TouchableWithoutFeedback>
                                {
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <View>
                                <TouchableWithoutFeedback onPress={() => this.goToCompetativeSheetReport(item.id)}>
