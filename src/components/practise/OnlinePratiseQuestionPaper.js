...
export default class OnlinePractiseQuestionPaper extends React.Component {
    ...
    getQuestions = (student_id) => {
        ...
        fetch(baseUrl + 'user', {
            ...
            body: qs.stringify({
                action: 'student_adaptive_practice',
    ...
    startExamTimer = async (test_id, user_id) => {
        fetch(baseUrl + 'user', {
            ...
            body: qs.stringify({
                action: 'adaptive_practice_exam_start_timer',
                user_id,
                test_id
            })
        }).then((response) => response.json())
    ...
    selectNextQuestion = (index) => {
        ...
        fetch(baseUrl + 'user', {
            ...
            body: qs.stringify({
                action: 'save_student_adaptive_practice_question',
    ...
    selectPreviousQuestion = (index) => {
        this.setState({ saveLoader: true })
        if (index.question_type == "fill_the_blanks") {
            var user_answer = JSON.stringify(this.state.userAnswer);
            var is_answered = this.state.is_answered;
        } else {
            var user_answer = index.user_answer
            var is_answered = index.is_answered
        }
        fetch(baseUrl + 'user', {
            method: 'POST',
            headers: {
    ...
    submitExam = (index) => {
        ...
        fetch(baseUrl + 'user', {
            ...
            body: qs.stringify({
                action: 'test_adaptive_practice_finished',
                test_id: this.state.test_id,
                parent_id: this.state.parent_id,
                user_id: this.state.student_id,
                question_id: this.state.question_id,
