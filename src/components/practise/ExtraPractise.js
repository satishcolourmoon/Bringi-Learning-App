...
export default class ExtraPractise extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                <StatusBar hidden />
                <Header title="Extra" title1="Practice" backScreen="SheetMenu" headerImage="submitSheet" navigation={this.props.navigation} />
