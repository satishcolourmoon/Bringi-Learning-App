    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <StatusBar hidden />
                <Header title="Online" title1="Report" backScreen="SkillAssessment" headerImage="la" navigation={this.props.navigation} />
                                ...
                                <TouchableWithoutFeedback onPress={() => this.getAnalysisData()}>
                                    <View>
                                        ...
                                        <View style={styles.center}>
                                            <Text style={this.state.selectedId == 0 ? styles.circleText1 : styles.circleText}>Competitive Practice</Text>
                                        </View>
                                    </View>
