...
export default class SheetStatus extends React.Component{
    ...
    getSheetList = async(student_id,subject_id) => {
        ...
        let postData = { 
            ...
            action : 'getstudent_pendingsheets',
            subject_id
        }
    ...
    goToReportCard = (id,status) => {
        if(status == "Corrected"){
            ...
            this.setState({showAlert:true,error_message:'Please submit your sheet'})
        }
    }
    ...
    render(){
        ...
        return(
             <View style={styles.container}>
                 ...
                 />
                 <Header title="Learning Sheet" title1="Status" backScreen="SheetMenu"  headerImage="confirmSubmit" navigation={this.props.navigation} />
                            ...
                            <View style={styles.tabContianer}>
                                <TouchableWithoutFeedback onPress={this.goToSubmittedSheets}>
                                    <View style={styles.tab}>
                                        <Text style={styles.tabText1}>SUBMITTED SHEETS</Text>
                                    </View> 
                                </TouchableWithoutFeedback>
                                <View style={styles.tab2}>
                                    <Text style={styles.tabText}>PENDING SHEETS</Text>
                                </View> 
                            </View>
                        </View>
                        <FlatList
                            ...
                            ListEmptyComponent={
                                <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                                    <Nodata title="No sheets Found.Please check back later"/>
                                </View>
                            }
...
<View>
    <View style={styles.round}>
        <View>
            <Image  source={require('../../assets/sci.png')} resizeMode="contain" style={styles.icon}/>
        </View>
    </View>
    <View style={styles.center}>
         <Text style={styles.circleText1}>Science</Text>
    </View>
</View>
 <View>
    <View style={styles.round}>
        <View>
            <Image  source={require('../../assets/abc.png')} resizeMode="contain"  style={styles.icon}/>
        </View>
    </View>
    <View style={styles.center}>
         <Text style={styles.circleText}>English</Text>
    </View>
</View>
<View>
    <View style={styles.round}>
        <View>
            <Image  source={require('../../assets/mths.png')} resizeMode="contain"  style={styles.icon}/>
        </View>
    </View>
    <View style={styles.center}>
         <Text style={styles.circleText}>Mathematics</Text>
    </View>
</View>
</View> */}