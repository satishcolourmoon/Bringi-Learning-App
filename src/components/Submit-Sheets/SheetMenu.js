...
export default class SheetMenu extends React.Component{
    ...
    goToSheetVideoMenu = () => {
        this.props.navigation.navigate('SheetVideoMenu');
    }
    render(){
        ...
        return(
            <View style={styles.container}>
                <StatusBar hidden />
                <Header title="Submit" title1="Learning Sheet" backScreen="Home"  headerImage="submitSheet" navigation={this.props.navigation} />
                <View style={styles.secondContainer}>
                    <View style={styles.row}>
                        <TouchableWithoutFeedback onPress={this.goToSubmitSheet}>
                            <Card containerStyle={styles.card}>
                                <View style={styles.cardImage}>
                                    <Image source={require('../../../assets/ss.png')}  resizeMode="contain"   style={styles.menuImage}/>
                                </View>
                                <View style={styles.cardTitle}>
                                    <Text style={styles.cardText}>SUBMIT</Text>
                                    <Text style={styles.cardText1}>SHEET</Text>
                                </View>
                            </Card>
                        </TouchableWithoutFeedback>
                        <TouchableWithoutFeedback onPress={this.goToSheetStatus}>
                            <Card containerStyle={styles.card}>
                                <View style={styles.cardImage}>
