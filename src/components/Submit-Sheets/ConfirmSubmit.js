...
import { View , StyleSheet , StatusBar , Image  , Text , BackHandler} from 'react-native';
    ...
    render(){
        ...
        return( 
            <View style={styles.container}>
                <StatusBar hidden />
                <Header title="Submit Learning" title1="Sheet Success" backScreen="SheetMenu"  headerImage="confirmSubmit" navigation={this.props.navigation} />
