...
export default class SheetStatus extends React.Component {
    ...
    getSheetList = async (student_id, subject_id) => {
        ...
        let postData = {
            ...
            action: 'getstudent_submittedsheets',
            subject_id
        }
    ...
    goToReportCard = (id, status) => {
        if (status == "Corrected") {
            ...
            this.setState({ showAlert: true, error_message: 'Sheet not corrected yet' })
        }
    }

    goToPendingSheets = () => {
        this.props.navigation.navigate('PendingSheets', {
            ...
            <View style={styles.container}>
                ...
                {/* <View style={styles.backMainContainer}>
                    ...
                    <View style={styles.descContainer}>
                        <Text style={styles.heading}>Learning Sheet</Text>
                        ...
                        <View style={styles.aboutContainer}>
                            <View style={styles.tabContianer}>
                                <View style={styles.tab1}>
                                    <Text style={styles.tabText}>SUBMITTED SHEETS</Text>
                                </View>
                                <TouchableWithoutFeedback onPress={this.goToPendingSheets}>
                                    <View style={styles.tab}>
                                        <Text style={styles.tabText1}>PENDING SHEETS</Text>
                                    </View>
                                </TouchableWithoutFeedback>
                            </View>
                        </View>
