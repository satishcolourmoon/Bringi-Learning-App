...
import { View, StyleSheet, StatusBar, Image, TouchableWithoutFeedback, Text, TextInput, Linking } from 'react-native';
...
export default class SheetVideo extends React.Component {
    ...
    onSuccess = async (e) => {
        ...
        if (json.status) {
            ...
            this.setState({ qr_code_scanner: false, showAlert: true, error_message: 'Invalid sheet id.Please enter manually', qr_code: '', reactivate: true, showScanner: false });
        }
    };
    openScanner = () => {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                <StatusBar hidden />
                <Header title="Submit" title1="Video" backScreen="SheetVideoMenu" headerImage="submitSheet" navigation={this.props.navigation} />
                ...
                <View style={{ flex: 0.3, justifyContent: 'center', alignItems: 'center', marginTop: hp('4') }}>
                    ...
                    {
                        !this.state.showScanner && !this.state.qr_code_scanner && <TouchableWithoutFeedback onPress={this.openScanner}>
