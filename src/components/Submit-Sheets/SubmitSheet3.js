...
export default class SubmitSheet2 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            upload_video: '',
            student_id: '',
            front_sheet_full_image: '',
            back_sheet_full_image: '',
            rough_sheet_full_image: '',
            btnLoader: false
                        ...
                        this.setState(
                            {
                                ...
                                front_sheet_full_image: resp.fullpath,
                        ...
                        this.setState(
                            {
                                ...
                                back_sheet_full_image: resp.fullpath,
                        ...
                        this.setState(
                            {
                                ...
                                rough_sheet_full_image: resp.fullpath,
                ...
                <View style={{ flex: 0.9, justifyContent: 'center', alignItems: 'center' }}>
                    <ScrollView>
                                ...
                                <View style={styles.inputContainer}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => this.showActionSheet('front')}>
                                        <View style={{ marginLeft: '2%', marginTop: '2%' }}>
                                            {
                                                this.state.front_sheet_full_image ?
                                                    <Image source={{ uri: this.state.front_sheet_full_image }} style={styles.frontImage} resizeMode="contain" /> :
                            ...
                            <View style={{ width: wp('50') }}>
                                <View style={styles.inputContainer}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => this.showActionSheet('back')}>
                                        <View style={{ marginLeft: '2%', marginTop: '2%' }}>
                                            {
                                                this.state.back_sheet_full_image ?
                                                    <Image source={{ uri: this.state.back_sheet_full_image }} style={styles.frontImage} /> :
                        ...
                        <View style={styles.row}>
                            <View style={{ width: wp('50') }}>
                                <View style={styles.inputContainer}>
                                    ...
                                    <Text style={styles.label3}>Optional </Text>

                                    <TouchableWithoutFeedback onPress={() => this.showActionSheet('rough')}>
                                        <View style={{ marginLeft: '2%', marginTop: '2%' }}>
                                            {
                                                this.state.rough_sheet_full_image ?
                                                    <Image source={{ uri: this.state.rough_sheet_full_image }} style={styles.frontImage} /> :
                        ...
                        <View style={{ marginTop: '5%' }}>
                            <Button onPress={this.SubmitSheet} backgroundColor="#ef1718" buttonTextColor="#ffffff" borderColor="#ef1718" borderWidth={1.5} text="SUBMIT" loader={this.state.btnLoader} />
                        </View>
