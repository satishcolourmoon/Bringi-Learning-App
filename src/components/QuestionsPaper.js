...
export default class QuestionPaperd extends React.Component {
    ...
    selectNextQuestion = (index) => {
        ...
        fetch(baseUrl + 'user', {
            ...
            body: qs.stringify({
                ...
                question_type: this.state.data[index].question_type,
        ...
        fetch(baseUrl + 'user', {
            ...
            .then((json) => {
                ...
                if (!json.status) {
                    ...
                    this.setState({ showAlert2: false, showAlert1: false, showAlert: false }, () => { this.props.navigation.navigate('LearningAnalysis') })
                }
            })
            .catch((error) => {
                this.setState({ loader: false });
